"""MoneySavingExpert scraper with network attribution.

MoneySavingExpert is an editorial/affiliate site, not an MNO or MVNO.
...
class MoneySavingExpertScraper(UnifiedScraper):
    ...
    def _extract_from_html(self, html, url):
        ...
        cards = soup.select(
            ...
            '[class*="product"], [class*="offer"], table tr'
        )
